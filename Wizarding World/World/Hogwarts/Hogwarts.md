...
graph TD
    ...
    %% Heads of Houses
    B --> C[Head of Gryffindor<br>Professor Longbottom]
    B --> D[Head of Hufflepuff<br>Professor Sprout]
    B --> E[Head of Ravenclaw<br>Professor GrimLock DADA]
    B --> F[Head of Slytherin<br>Professor Slughorn]
    ...
    A --> Z1[School Head Girl<br>Ginny Weasley]
