...
En Terragnoma gobierna una pareja real: los reyes Gnerkli y Korboz. Recientemente, Korboz enloqueció y decidió mantener recluido a Gnerkli. Los súbditos no comprenden la naturaleza de la enfermedad mental de su monarca y no saben cómo manejar la situación. El pueblo no desea ningún mal a la pareja real, pero reconoce que Korboz se ha vuelto un peligro tanto para sí mismo como para los demás.
...
- Un amuleto de relojería (de la zona T13)
- Una pértiga contraíble (de la zona T13)
- Una varita de pirotecnia (regalo del rey Gnerkli)
- Un sombrero de hechicería (regalo del rey Korboz)

Si los personajes consiguen e identifican alguno de estos objetos mágicos, entrégales a los jugadores las cartas correspondientes.

## Llegada

Un arroyo conduce a los personajes a una charca alimentada por una cascada que se precipita por la ladera de la montaña.
...
**Puntos de Golpe:** 30  
**Fuerza:** 10  
**Inmunidades:** daño de veneno, daño psíquico  
...
**Pinzas.** *Ataque con arma cuerpo a cuerpo:* +2 al golpear, alcance 5 pies, un objetivo. *Impacto:* 5 (2d4) de daño perforante y el objetivo queda agarrado (CD 10 para escapar). ### T7. Plataforma con Ballestas de Recarga Automática

En esta sala hay una plataforma giratoria fijada al suelo y equipada con cuatro ballestas pesadas que se recargan automáticamente. Cada ballesta cuenta con un cargador de veinte virotes. Sobre la plataforma hay un asiento elevado a 6 pies de altura, equipado con pedales para hacer que el artilugio gire en sentido antihorario y palancas para recargar y disparar las ballestas.
...
**Ballesta pesada.** *Ataque con arma a distancia:* +5 al golpear, alcance 50/200 pies, un objetivo. *Impacto:* 5 (1d10) de daño perforante.

Cuando los personajes entren por primera vez en esta zona, se encontrarán con una figura sentada en el asiento: Facktoré, la gnoma de las rocas solitaria que inventó el artilugio. Al ver a los forasteros, Facktoré decidirá probar su invento con ellos, disparando inmediatamente. Solo dejará de disparar cuando el aparato deje de funcionar o cuando ya no vea objetivos a la vista.

La gnoma está mentalmente trastornada y completamente obsesionada con su trabajo. Apenas puede articular una oración coherente, y mucho menos dar indicaciones útiles a los visitantes sobre a dónde ir o con quién hablar.
...
hit_dice: 3d6+3
speed: 25ft
stats: [8, 16, 12, 15, 10, 9]
fage_stats: [-1, +3, +1, +2, +0, -1]
skillsaves:
  - Arcana: +4
  - Percepción: +2
  - Destreza: +5
senses: Visión en la oscuridad 60 pies, Passive Perception 12
languages: Común, Gnomo
cr: 1/4
traits:
  - name: Astucia Gnoma
    desc: "Ventaja en todas las tiradas de salvación de Inteligencia, Sabiduría y Carisma contra magia."
  - name: Inventora Obsesiva
    desc: "Facktoré tiene ventaja en tiradas de ataque con sus propios inventos y puede usar su modificador de Inteligencia en lugar del de Fuerza o Destreza para ataques con ellos."
  - name: Inestabilidad Mental
    desc: "Al inicio de su turno, tira 1d6. Con un 1, Facktoré queda confundida (como el efecto del hechizo) hasta el inicio de su siguiente turno."
actions:
  - name: Control de Ballesta
    desc: "Facktoré dispara hasta dos ballestas de su plataforma. *Ataque con arma a distancia:* +5 al golpear, alcance 50/200 pies, un objetivo. *Impacto:* 5 (1d10) de daño perforante."
  - name: Llave Inglesa
    desc: "Ataque con arma cuerpo a cuerpo: +1 al golpear, alcance 5 pies, un objetivo. *Impacto:* 2 (1d4-1) de daño contundente."
  - name: Granada de Humo (1/día)
    desc: "Facktoré lanza un pequeño dispositivo que explota en una nube de humo denso. Todas las criaturas en un radio de 10 pies desde un punto que ella pueda ver a 20 pies deben hacer una tirada de salvación de Constitución CD 12 o quedar cegadas durante 1 minuto. Una criatura afectada puede repetir la tirada al final de cada uno de sus turnos, terminando el efecto en un éxito."
equipment:
  - "Llave inglesa"
  - "Tres granadas de humo (solo una funciona)"
  - "Goggles de visión excéntrica"
``` ### T8. Mimeto y Vino de Champiñón

Esta sala contiene doce barriles de 40 galones dispuestos en amplios huecos de la pared. Cada barril está asegurado por una abrazadera de madera.

Los barriles del hueco sur están perforados con espitas de madera. Dos están medio llenos y otros dos, casi vacíos. 

Siete de los ocho barriles de los huecos norte y este no tienen espitas y están llenos de vino de champiñón. El octavo barril es en realidad un mimeto disfrazado. Puedes decidir dónde se encuentra la criatura o tirar 1d8 para determinar al azar qué barril es falso. Consulta la sección "Monstruo Misterioso" más adelante para saber más sobre el mimeto y cómo actúa cuando es descubierto.

```statblock
name: Mimeto
size: Medium
type: monstruosidad
subtype: (cambiaformas)
alignment: Neutral
ac: 12
hp: 58
hit_dice: 9d8+18
...
fage_stats: [+3, +1, +2, -3, +1, -1]
skills:
  - Sigilo: +5
damage_resistances: contundente
damage_immunities: ácido
condition_immunities: tumbado
senses: visión ciega 60 pies (ciego más allá de este radio), Passive Perception 11
languages: -
cr: 2
traits:
  - name: Cambiaformas
    desc: "El mimeto puede usar su acción para transformarse en un objeto u adoptar su forma amorfa. Sus estadísticas son las mismas en cada forma. Cualquier equipo que lleve puesto o transporte no se ve afectado por esta transformación. Vuelve a su forma verdadera al morir."
  - name: Aspecto Falso
    desc: "Mientras el mimeto permanezca inmóvil, es indistinguible de un objeto ordinario."
  - name: Adhesivo (Forma de Objeto)
    desc: "El mimeto se adhiere a cualquier cosa que lo toque. Una criatura de tamaño Grande o menor que quede adherida al mimeto también queda apresada (CD 13 para escapar). Las pruebas de característica para escapar se realizan con desventaja."
  - name: Corrosión
    desc: "Una arma u objeto de metal no mágico que impacte al mimeto se corroe. Después de causar daño, el arma sufre un penalizador permanente acumulativo de -1 a las tiradas de daño. Si el penalizador llega a -5, el arma se destruye. Las municiones no mágicas se destruyen tras infligir daño."
  - name: Transparencia Falsa (Forma de Objeto)
    desc: "Aunque el mimeto sigue siendo visible, realiza sus tiradas de Destreza (Sigilo) con ventaja mientras no se mueva o realice acciones."
actions:
  - name: Pseudópodo
    desc: "Ataque con arma cuerpo a cuerpo: +5 al golpear, alcance 5 pies, un objetivo. Impacto: 7 (1d8+3) de daño contundente. Si el objetivo es Medium o más pequeño, queda agarrado (CD 13 para escapar). Mientras el objetivo esté agarrado, el mimeto no puede usar su pseudópodo contra otro objetivo."
  - name: Engullir
    desc: "El mimeto engulla a una criatura de tamaño Medium o más pequeña que tenga agarrada. La criatura engullida queda cegada y apresada, tiene cobertura total contra ataques y otros efectos provenientes del exterior del mimeto, y sufre 7 (2d6) de daño por ácido al inicio de cada turno del mimeto. Si el mimeto asume la forma de un objeto, la criatura engullida no es visible. El mimeto solo puede tener una criatura engullida a la vez."
``` ### T9. Puesto de Guardia Gnomo

Esta cueva vacía está húmeda debido al rocío de la cascada y presenta una cornisa a 10 pies de altura en la parte sur. Se puede llegar a la cornisa por el túnel circular hacia el este o escalando la pared de piedra resbaladiza tras superar una prueba de Fuerza (Atletismo) CD 12.

En la cornisa se encuentran dos gnomos de las rocas solitarios: una mujer llamada Ulla y un hombre llamado Pog. Cuando un personaje entre en la cueva, Ulla gritará: "¿Quién anda ahí?" en gnomo, y Pog repetirá la pregunta en común.

Los dos gnomos han recibido órdenes estrictas de atacar a cualquier cambiaformas que se presente. Como cualquier criatura podría ser un cambiaformas disfrazado, atacarán a quienes no puedan demostrar convincentemente su identidad.

Para evitar ser atacados, los personajes deberán superar una de las siguientes pruebas:
- Una prueba de Carisma (Engaño) CD 10 para hacer creer a los gnomos que el grupo tiene una audiencia con los reyes de Terragnoma.
- Una prueba de Carisma (Intimidación) CD 10 para asustar a los gnomos haciéndoles pensar que atacar al grupo provocaría la destrucción de las cuevas.
- Una prueba de Carisma (Persuasión) CD 10 para convencer a los gnomos de que los personajes no son cambiaformas, argumentando que estos adoptarían formas menos llamativas.

```statblock
name: Ulla y Pog (guardias gnomos)
size: Small
type: humanoid
subtype: (gnomo)
...
hit_dice: 3d6+3
speed: 25ft
stats: [14, 14, 13, 10, 12, 11]
fage_stats: [+2, +2, +1, +0, +1, +0]
skillsaves:
  - Percepción: +3
  - Sigilo: +4
  - Investigación: +2
...
traits:
  ...
  - name: Comunicación con Animales Pequeños
    desc: "Mediante sonidos y gestos, los gnomos pueden comunicar ideas sencillas con bestias Pequeñas o más pequeñas."
  - name: Táctica de Equipo
    desc: "Los gnomos tienen ventaja en tiradas de ataque contra una criatura si al menos uno de sus aliados está a 5 pies de la criatura y no está incapacitado."
actions:
  - name: Espada Corta
  ...
  - name: Ballesta Ligera
    desc: "Ataque con arma a distancia: +4 al golpear, alcance 80/320 pies, un objetivo. Impacto: 6 (1d8+2) de daño perforante."
  - name: Silbato de Alarma (1/día)
    desc: "Ulla lleva un silbato mágico que, al soplarlo, emite un sonido agudo que solo pueden oír otras criaturas en Terragnoma. Cuando lo usa, todos los gnomos en un radio de 300 pies quedan alertados del peligro y conocen su ubicación."
equipment:
  - "Espada corta"
  - "Ballesta ligera con 20 virotes"
  - "Cota de malla ligera"
  - "Silbato de alarma (solo Ulla)"
  - "Bolsa con 12 po y 25 pp (entre los dos)"
```
...
En Terragnoma habitan veinte gnomos de las rocas solitarios (consulta su perfil en la página 61), entre ellos el rey Gnerkli y el rey Korboz. Los nombres de los gnomos y su paradero se describen en la sección "Lugares de Terragnoma"

### MONSTRUO MISTERIOSO

En las cuevas solían vivir 22 gnomos, pero un mimeto (consulta su perfil en la página 66) ha devorado a dos de ellos (Orryn y Warryn) en la última decana. Actualmente, la criatura se have pasar por un barril en la zona T8. A menos que la derroten, seguirá devorando gnomos en cuanto vuelva a tener hambre. El mimeto puede moverse y cambiar de apariencia según le convenga, aunque solo puede convertirse en objetos Medianos como sillas, baúles grandes, atriles e inventos gnomos extraños

de su misma masa y tamaño. También puede camuflarse corno una puerta, una sección falsa del muro o una protuberancia rocosa del suelo. Tras conversar con Korboz, quien les advierte de la presencia de un rnonstro carnbiaforrnas, el objetivo principal de los personajes será encontrarlo y acabar con él. Cuando atacó a Korboz en la sala del trono (zona Tl4), la criatura aparentaba set una alfombra de 10 pies cuadrados, pero desde entonces se desconoce su paradero y su forma actual. Si se les presiona, los gnomos ayudarán a los personajes a encontrar al rnirneto y golpearán diversos objetos con varitas no mágicas para comprobar si cobran vida y atacan. Sin embargo, los gnomos no son aventureros y huirán ante el mínimo indicio de peligro (ya sea real o imaginario). El rnirneto devora y disuelve por completo a sus víctimas sin dejar rastro y cambia de ubicación tras cada presa. No se marchará de Terragnorna de buena gana, ya que le ha cogido el gusto a la carne de gnomo. Si quieres crear un antagonista más interesante, haz que el mi meto sea una de las subespecies raras que pueden mantener conversaciones sencillas en común. Los personajes que arrinconen al rnirneto parlante podrán negociar con él y obligarle a abandonar Terragnorna si superan una prueba de Carisma (Intimidación o Persuasión) con CD 15.

### MAGIA SALVAJE

Desde have mucho tiempo, Terragnorna es una fuente de la incontrolable magia salvaje. Cuando una criatura gaste un espacio de conjuro para lanzar un conjuro de nivel l o superior en cualquier lugar del mapa de Terragnoma, puede producirse un efecto adicional. Tira ld20 y consulta la siguiente tabla para determinar el efecto, si es que se produce. Este efecto de magia salvaje se disipará tras una hora o si se usa un conjuro levantar maldición u otros similares.
